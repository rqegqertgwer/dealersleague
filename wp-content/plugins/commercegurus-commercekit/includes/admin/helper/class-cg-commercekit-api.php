...
class CG_Commercekit_API {
	...
	public static function load() {
		// self::$api_base = apply_filters( 'commercegurus_commercekit_api_base', 'https://staging.commercegurus.com/wp-json/cgsubs/v2' );
		// self::$api_base = apply_filters( 'commercegurus_commercekit_api_base', 'http://commercegurus.local/wp-json/cgsubs/v2' );
