...
/*jQuery('.attachment-thumbnail').before().on('click', function(){
	if(jQuery('.flex-control-nav').css('transform') <= 'translate3d(0px, 0px, 0px)'){
		jQuery('.gallery-arrow-down').css('display', 'none');
    }else{
