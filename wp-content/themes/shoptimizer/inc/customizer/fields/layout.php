...
shoptimizer_Kirki::add_field(
	'shoptimizer_config', array(
		...
		'choices'  => array(
			...
			'yoast'  => esc_attr__( 'Use Yoast Breadcrumbs', 'shoptimizer' ),
			'rankmath'  => esc_attr__( 'Use Rank Math Breadcrumbs', 'shoptimizer' ),
		),
		'priority' => 10,
	)
);
...
// Display Inventory FOMO.
shoptimizer_Kirki::add_field(
	'shoptimizer_config', array(
		'type'      => 'toggle',
		'settings'  => 'shoptimizer_layout_inventory_display',
		'label'     => esc_html__( 'Display inventory FOMO', 'shoptimizer' ),
		'section'   => 'shoptimizer_layout_section_woocommerce',
		'default'   => '0',
		'priority'  => 10,
		'transport' => 'refresh',
